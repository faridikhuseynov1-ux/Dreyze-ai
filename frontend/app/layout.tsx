...
export const metadata: Metadata = {
  ...
  description: "Dreyze AI, DreyzeAI и Дрейзи АИ - приватный AI-чат с памятью, множеством передовых моделей (ChatGPT, Claude, Gemini, DeepSeek) и расширенными режимами работы.",
  keywords: ["Dreyze AI", "DreyzeAI", "Dreyze", "дрейзи аи", "дрейз аи", "AI chat", "нейросеть чат", "ИИ ассистент", "ChatGPT альтернатива", "Claude альтернатива", "приватный чат", "dreyzfarid"],
  ...
  openGraph: {
    ...
    title: "Dreyze AI - Дрейзи АИ нейросеть и умный ИИ-ассистент",
