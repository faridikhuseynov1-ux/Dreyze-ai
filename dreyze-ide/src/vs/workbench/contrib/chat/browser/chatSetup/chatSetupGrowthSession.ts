...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Open Dreyze AI"),
			description: localize('growthSession.description', "Dreyze AI is available. Open the built-in coding agent."),
...
export class GrowthSessionOpenerParticipant implements ISessionOpenerParticipant {
	...
	async handleOpenSession(accessor: ServicesAccessor, session: IAgentSession, _openOptions?: ISessionOpenOptions): Promise<boolean> {
		...
		const opts: IChatViewOpenOptions = {
			...
			isPartialQuery: true,
			previousRequests: [{
				request: localize('growthSession.previousRequest', "Tell me about Dreyze AI!"),
				// allow-any-unicode-next-line
				response: localize('growthSession.previousResponse', "Welcome to Dreyze AI, your built-in coding agent. You can ask it to debug errors, write tests, explain selected code, scaffold features, refactor files, and produce commands for your project.\n\nOpen Dreyze AI from the activity bar to get started."),
			}],
		};
